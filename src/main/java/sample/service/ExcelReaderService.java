...
public class ExcelReaderService {
    ...
    public InsumoVista leeArchivo(String rutaArchivo) throws IOException {
        ...
        excelColumnas = new String[firstSheet.getLastRowNum()][firstSheet.getRow(0).getLastCellNum()];
        ...
        insumosVista.getListElements().forEach(System.out::println);
        ...
        excelColumnas = new String[secondSheet.getLastRowNum()][secondSheet.getRow(0).getLastCellNum()];
        ...
        while (iterator.hasNext()) {
            ...
            if(i<secondSheet.getLastRowNum()) {
                ...
                insumosVista.getListElements().add(new Elemento(excelColumnas[i][0], excelColumnas[i][1],
